            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                   <img src="img/briks.png"
                    style="width: 20rem;" alt="logo">
                  <!-- <h1 class="mt-1 mb-5 pb-1"><font class="text-primary">BRI</font><font class="text-warning">KS</font></h1> -->
                </div>
                <?php 
  if(isset($_GET['alert'])){
  ...
  ?>
                <form method="POST" action="aksi.php" role="form">
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="text" name="username" id="form2Example11" class="form-control"
                      placeholder="Masukkan Username" spellcheck="true" />
                  </div>
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">PT. BRIKS CABANG MAKASSAR</h4>
                <p class="small mb-0">BRIKS teguh dengan spirit of enterprise, baik dalam mengambil inisiatif berfikir kreatif, bekerja sama, memegang teguh budaya perusahaan, berkomitmen memberi layanan cepat dan memuaskan.</p>
              </div>
            </div>
          </div>
        </div>
